...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo url('/people/clients'); ?>"><?php echo __('Customers'); ?></a></li>
            <li class="active"><?php echo __('Add Customer'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Add Customer'); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo url('people/clients/store'); ?>" method="post" name="client_add_form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('present_address') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="present_address" id="present_address" class="form-control" value="<?php echo old('present_address'); ?>" placeholder="<?php echo __('Enter address..'); ?>">
                            ...
                            <div class="form-group<?php echo $errors->has('contact_no_two') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control" value="<?php echo old('contact_no_two'); ?>" placeholder="<?php echo __('Enter contact no..'); ?>">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo __('Add client'); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['client_add_form'].elements['gender'].value = "<?php echo old('gender'); ?>";
    document.forms['client_add_form'].elements['client_type_id'].value = "<?php echo old('client_type_id'); ?>";
    document.forms['client_add_form'].elements['designation_id'].value = "<?php echo old('designation_id'); ?>";
</script>
