    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="<?php echo url('/hrm/salary/statement/view'); ?>" method="get">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group<?php echo $errors->has('user_id') ? ' has-error' : ''; ?>">
              ...
              <div class="col-sm-3">
                <select name="emp_id" id="user_id" class="form-control">
                  ...
                  <option value="<?php echo $employee['user_id']; ?>"><strong><?php echo $empname; ?> [<?php echo date("F Y", strtotime($employee['payment_month'])); ?>]</option>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i> <?php echo __('View Salary Statement'); ?></button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
