      ...
      <form action="<?php echo url('/hrm/leave_application/store'); ?>" method="post" name="add_form_leave_application">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <label for="leave_category"><?php echo __('Leave Category '); ?><span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                <label><?php echo __('Date of return from Last Leave:'); ?></label>
              ...
              <label for="last_leave_period"><?php echo __('Period of Last Leave'); ?> <span class="text-danger"></span></label>
              <div class="form-group<?php echo $errors->has('last_leave_period') ? ' has-error' : ''; ?> has-feedback">
                <input type="text" name="last_leave_period" id="last_leave_period" class="form-control" value="<?php echo old('last_leave_period'); ?>" placeholder="<?php echo __('Enter Period of Last Leave..'); ?>">
                <?php if($errors->has('last_leave_period')): ?>
                <span class="help-block">
                  <strong><?php echo $errors->first('last_leave_period'); ?></strong>
                </span>
                <?php endif; ?>
              </div>
              <!-- /.form-group -->

               <label for="leave_category"><?php echo __('Category of Last Leave'); ?> <span class="text-danger"></span></label>
              <div class="form-group<?php echo $errors->has('leave_category') ? ' has-error' : ''; ?> has-feedback">
              ...
              <label for="leave_address"><?php echo __('Leave Address'); ?> <span class="text-danger"></span></label>
              <div class="form-group<?php echo $errors->has('leave_address') ? ' has-error' : ''; ?> has-feedback">
                <textarea class="textarea text-description" name="leave_address"  placeholder="<?php echo __('Enter leave_address..'); ?>"><?php echo old('leave_address'); ?></textarea>
                <?php if($errors->has('leave_address')): ?>
                <span class="help-block">
                  <strong><?php echo $errors->first('leave_address'); ?></strong>
                </span>
                <?php endif; ?>
              </div>
              <!-- /.form-group -->

                <label for="during_leave"><?php echo __('Performing person during leave'); ?> <span class="text-danger"></span></label>
              <div class="form-group<?php echo $errors->has('during_leave') ? ' has-error' : ''; ?> has-feedback">
                <input type="text" name="during_leave" id="during_leave" class="form-control" value="<?php echo old('during_leave'); ?>" placeholder="<?php echo __('Enter Performing person during leave..'); ?>">
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo __('Add leave application'); ?></button>
        </div>
      </form>
    </div>
    <!-- /.box -->
...
document.forms['add_form_leave_application'].elements['publication_status'].value = "<?php echo old('publication_status'); ?>";
</script>
