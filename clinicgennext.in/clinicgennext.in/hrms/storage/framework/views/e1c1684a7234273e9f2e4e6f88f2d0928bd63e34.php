...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           <?php echo __('Manage Holiday Lists'); ?> 
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i><?php echo __('Dashboard'); ?> </a></li>
            <li><a><?php echo __('Setting'); ?></a></li>
            <li class="active"><?php echo __('Manage Holiday Lists'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage Holiday Lists'); ?></h3>
            ...
            <div class="box-body">
                ...
                <div  class="col-md-6">
                    <a href="<?php echo url('/setting/holidays/create'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i><?php echo __(' Add Holiday Lists'); ?></a>
                </div>
                <div  class="col-md-6">
                        ...
                        <tbody id="myTable">
                          ...
                          <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo str_limit($holiday['description'], 65); ?></td>
                                ...
                                <td class="text-center">
                                   <a href="<?php echo url('/setting/holidays/edit/' . $holiday['id'] ); ?>"><i class="icon fa fa-edit"></i> <?php echo __('Edit'); ?></a>
                                </td>
                            </tr>
