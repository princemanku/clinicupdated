          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                <li class="nav-item">
                  <a class="dropdown-item" href="<?php echo e(url('/')); ?>"><i class="fa fa-dashboard"></i> <span><?php echo e(trans('file.dashboard')); ?></span></a>
                </li>
                ...
                <li class="nav-item"><a class="dropdown-item" href="<?php echo e(route('setting.pos')); ?>"><i class="fa fa-cog"></i>  <span><?php echo e(trans('file.POS Setting')); ?></span></a> </li>
                <?php endif; ?>
