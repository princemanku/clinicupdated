        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i><span><?php echo e(trans('file.Purchase')); ?></span></a>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-calculator"></i><span><?php echo e(trans('file.Expense')); ?></span></a>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="icon-page"></i><span><?php echo e(trans('file.Quotation')); ?></span><span></a>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-share"></i><span><?php echo e(trans('file.Transfer')); ?></span></a>
              ...
              <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-archive"></i><span><?php echo e(trans('file.return')); ?></span></a>
              ...
              <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i><span><?php echo e(trans('file.Accounting')); ?></span></a>
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><span><?php echo e(trans('file.People')); ?></span></a>
              ...
              <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-paper-outline"></i><span><?php echo e(trans('file.Reports')); ?></span></a>
                <?php
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><span><?php echo e(trans('file.settings')); ?></span></a>
        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big"><?php if($general_setting->site_logo): ?><img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="50">&nbsp;&nbsp;<?php endif; ?><h1 class="d-inline"><?php echo e($general_setting->site_title); ?></h1></span>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li class="nav-item"><a class="dropdown-item" href="<?php echo e(route('sale.pos')); ?>"><i class="fa fa-th-large"></i><span> POS</span></a></li>
                <?php endif; ?>            
                ...
                <li class="nav-item"> 
                    <a class="dropdown-item" href="<?php echo e(url('read_me')); ?>" target="_blank"><i class="fa fa-info-circle"></i> <?php echo e(trans('file.Help')); ?></a>
                </li>&nbsp;
                <li class="nav-item">
                      <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="fa fa-user"></i> <span><?php echo e(ucfirst(Auth::user()->name)); ?></span> <i class="fa fa-angle-down"></i>
                      </a>
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          <li> 
                          ...
                          <?php endif; ?>
                          <li> 
                            <a href="<?php echo e(url('my-transactions/'.date('Y').'/'.date('m'))); ?>"><i class="ion-arrow-swap"></i> <?php echo e(trans('file.My Transaction')); ?></a>
                          </li>
                          <li> 
                            <a href="<?php echo e(url('holidays/my-holiday/'.date('Y').'/'.date('m'))); ?>"><i class="fa fa-plane"></i> <?php echo e(trans('file.My Holiday')); ?></a>
                          </li>
                          <?php if($empty_database_permission_active): ?>
                          <li>
                            <a onclick="return confirm('Are you sure want to delete? If you do this all of your data will be lost.')" href="<?php echo e(route('setting.emptyDatabase')); ?>"><i class="fa fa-database"></i> <?php echo e(trans('file.Empty Database')); ?></a>
                          </li>
                          <?php endif; ?>
                          <li>
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'accounts.store', 'method' => 'post']); ?>
                      ...
                      <div class="form-group">
                          <label><strong><?php echo e(trans('file.Account No')); ?> *</strong></label>
                      ...
                      <div class="form-group">
                          <label><strong><?php echo e(trans('file.Initial Balance')); ?></strong></label>
                  ...
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'accounts.statement', 'method' => 'post']); ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label><strong> <?php echo e(trans('file.Type')); ?></strong></label>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p><?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="https://clinicgennext.com" class="external">HARJEET</a></p>
            </div>
          </div>
        </div>
      </footer>
