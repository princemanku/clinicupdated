;(function($){
	...
	$(document).ready(function(){
        $("#contact-us-form").load("contact-form.html #contact-us", function () {
            $("#contact-us-form-mob").load("contact-form.html #contact-us-mob", function () {
                $("#modal-forms").load("modal-forms.html", function () {
                    DH.init();
                });
            });
        });
